...
const ConstructionPage = () => {
  return (
    <div className="bg-primary">
      <div className="max-x-5xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="max-x-xl mx-auto py-16 sm:py-24">
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-wide text-indigo-600">
              Coming soon
            </p>
            <h1 className="mt-2 text-4xl font-extrabold tracking-tight text-secondary sm:text-5xl">
              Under Construction
            </h1>
            <p className="mt-2 text-lg text-accent-500">
              This page is under construction, but we are ready to got Special
              surprise for you
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <ul
              role="list"
              className="mt-4 divide-y divide-accent-200 border-t border-b border-accent-200"
            >
              {links.map((link, id) => (
                <li
                  key={id}
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base font-medium text-accent-800">
