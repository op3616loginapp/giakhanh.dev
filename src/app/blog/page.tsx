      ...
      <div className="mb-8 space-y-8">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-md border border-accent-200 bg-primary py-2 px-3 pl-12 transition-colors duration-200 ease-linear focus:border-accent-500 focus:outline-none"
            id="search"
          />
